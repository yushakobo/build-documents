...
#### 2-1 キープレートの裏表の確認
キープレートには裏表があります。キープレートの表面は、キースイッチが入る穴のみがアクリル板に加工されています。キープレートの裏面はキースイッチが入る穴に加えて穴の上下にキースイッチを固定する爪がかかる溝が加工されています。

![ キープレートの裏表](imgs/AluminiumCase/P7assemblyKeyplate/PIC1.png)
...
#### 2-3 キースイッチの挿入
キースイッチをキープレートの表面から挿入します。キープレートの表面は、キースイッチが入る穴のみがアクリル板に加工されています。キープレートの裏面はキースイッチが入る穴に加えて穴の上下にキースイッチを固定する爪がかかる溝が加工されています。
正しい向きから挿入すると、キースイッチの爪がキープレートの溝にかかりしっかりと固定されます。逆向きから挿入すると爪がかかる箇所がないため、簡単に抜けます。
